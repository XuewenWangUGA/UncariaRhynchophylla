...
input=$inFastaSeq.aln #bait gene  alignment from previous pep.fasta
...
python get_covered_hit_fromHmm.py -i ${GeneName}_all_genes_in_genome.n.txt -o ${GeneName}_all_genes_in_genome.hmm.filtered.tsv -e 1e-10 -s 100
